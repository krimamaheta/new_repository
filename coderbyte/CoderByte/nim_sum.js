...
//  *
//  * 
//  * //if 0 remain so loose 2 otherwise win so return 1//
 

function nimsum(strArr)
{
    let nims=strArr.reduce((acc,pile)=>acc^pile,0)

    let winner=nims===0?2:1;
     
    return winner;
}
console.log(nimsum([2, 4, 1, 3]))

//here winner retuen 1
