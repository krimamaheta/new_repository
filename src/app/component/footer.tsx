...
import Style from "./../../app/home/card.module.css"
const Footer=()=>{
    return(
        <div>
    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">Bussiness devlopment team surat</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Email:eventmaker@gmail.com</a>
          </li>
